...
### Commit-discipline
- `[Codex]` prefix op commits van Codex.
- `[codex]` prefix op commits van Codex (GPT-reviewer).
- `[Codex+codex]` voor gezamenlijke releases.
...
## Samenwerking Codex × Codex

### Werkmodel
- **Codex codet, Codex reviewt** (tenzij anders afgesproken per slice).
...
### Codex-specifieke discipline (Codex-feedback 2026-04-17)
