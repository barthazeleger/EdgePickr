...
// v10.8.19: 2.0U-threshold verhoogd van 0.10 naar 0.11 zodat stake-tier
// consistent is met score 9+ (score 9 begint bij hk ≥ 0.1095). Voorheen kon
// hk=0.105 → score 8 + 2.0U (inconsistent). Nu vraagt 2.0U altijd score 9+.
// Brackets aligned met kellyScore(): score 6 → 0.75U, 7 → 1.0U, 8 → 1.5U, 9+ → 2.0U.
function kellyToUnits(hk) {
  if (hk > 0.11)  return '2.0U';
