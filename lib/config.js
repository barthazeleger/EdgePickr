...
// v12.6.0 · Per-sport api-sports.io key-splitsing. Operator-keuze: voetbal Pro
// $20/mnd + 5 andere sporten gratis-tier (100 calls/dag elk). Alle env-vars zijn
// optioneel — fallback op AF_KEY behoudt backwards-compat met All-Sports-bundle
// setups die alleen API_FOOTBALL_KEY zetten. Gebruik in afGet via
// resolveSportFromHost() voor automatische sport-key-lookup.
...
module.exports = {
  ...
  AF_KEY, SPORT_API_KEYS, resolveSportFromHost,
  CURRENT_SEASON, SPLIT_SEASON, CALENDAR_SEASON,
