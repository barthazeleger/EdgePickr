  ...
  router.get('/admin/v2/concept-drift', requireAdmin, async (req, res) => {
    try {
      ...
      for (const [, g] of grouped) {
        ...
        // v12.3.0 P2 fix: vergelijk RAW deltas tegen drempel (geen toFixed-rounding
        // in de comparison). Voorheen kon delta = exact threshold (bv. 0.02000001
        // → toFixed → 0.02 → !> 0.02) een drift-signaal ten onrechte missen.
        const rawD90 = (w90 && w90.brier != null) ? (w30.brier - w90.brier) : null;
        const rawD365 = (w365 && w365.brier != null) ? (w30.brier - w365.brier) : null;
        const driftV90 = rawD90 != null && rawD90 > driftThreshold;
        const driftV365 = rawD365 != null && rawD365 > driftThreshold;
        ...
        drifts.push({
          ...
          n90: w90?.n ?? null,
          n365: w365?.n ?? null,
          delta30v90: rawD90 != null ? +rawD90.toFixed(5) : null,
          delta30v365: rawD365 != null ? +rawD365.toFixed(5) : null,
          driftV90,
          driftV365,
        });
      }
