...
module.exports = function createAdminSourcesRouter(deps) {
  ...
  const VALID_SOURCE_NAMES = ['sofascore', 'fotmob', 'thesportsdb', 'oddspapi', 'nba-stats', 'nhl-api', 'mlb-stats-ext'];
  ...
  router.get('/admin/v2/scrape-diagnose', requireAdmin, async (req, res) => {
    try {
      ...
      const probes = {
        ...
        'oddspapi': { url: 'https://api.oddspapi.io/v4/sports', hosts: ['api.oddspapi.io'] },
      };
