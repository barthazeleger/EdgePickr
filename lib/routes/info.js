...
module.exports = function createInfoRouter(deps) {
  ...
  const { afKey, afRateLimit, sportRateLimits, tsdbAdapter, getCurrentStakeRegime, leagues } = deps;
    ...
    router.get('/status', (req, res) => {
      ...
      res.json({
        ...
        services: {
          ...
          oddsApi: {
            status: process.env.ODDSAPI_KEY ? 'active' : 'planned',
            plan: 'Free 500/mo',
            note: 'The Odds API · v4 · Bet365/Pinnacle/Unibet odds · h2h/spreads/totals · adapter komt in v13.0 Phase 2',
            unlimited: false,
          },
