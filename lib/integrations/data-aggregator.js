...
// (zie module-comment hierboven). TSDB Premium dekt h2h voor alle 6 actieve
// sporten. Form-events vallen voor de sporten zonder externe form-source
// terug op api-sports' fixtures-endpoint binnen server.js. nbaStats / nhlApi
// / mlbExt blijven als sport-specifieke summary-bronnen.
const SPORT_SOURCES = {
  football: {
    h2h: [thesportsdb],
    form: [thesportsdb],
...
async function healthCheckAll() {
  const sources = [thesportsdb, nbaStats, nhlApi, mlbExt];
