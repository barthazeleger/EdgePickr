...
// v12.5.12: TheSportsDB toegevoegd als alternatieve h2h-bron. sofascore +
// fotmob zijn vanaf Render's IP-segment 403/404 (cloudflare-block resp.
// endpoint-change), TheSportsDB heeft simpele open-API zonder anti-bot.
...
//
// v12.6.0: TheSportsDB toegevoegd aan h2h voor ALLE sporten. Adapter is
// sport-aware (filtert search op strSport) en met premium-key heeft het
// betrouwbare lookuph2h-data — vult de gap die overblijft nu sofascore op
// Render's IP-segment dood is.
const SPORT_SOURCES = {
  football: {
    h2h: [sofascore, fotmob, thesportsdb],
    form: [sofascore, fotmob],
    summary: [],
  },
  basketball: {
    h2h: [sofascore, thesportsdb],
    form: [sofascore],
    summary: [nbaStats],
  },
  hockey: {
...
async function healthCheckAll() {
  const sources = [sofascore, fotmob, thesportsdb, nbaStats, nhlApi, mlbExt];
