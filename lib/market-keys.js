...
// v12.2.28: f5_total weggehaald — detectMarket returnt nu f5_over/f5_under
// dus calibration-bucket en CLV-shape zijn niet langer asymmetrisch voor F5.
...
function detectMarketKeyDrift(markt, opts = {}) {
  ...
  // v12.2.28: F5 totals krijgen eigen bucket (f5_over/f5_under) ipv main 'over'/'under'.
  if (cs.market_type === 'f5_total' && (lb === `f5_${sel}` || lb === sel)) return null;
