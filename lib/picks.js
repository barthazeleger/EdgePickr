...
function buildPickFactory(MIN_ODDS = 1.60, calibEpBuckets = {}, options = {}) {
  ...
  const { drawdownMultiplier, activeUnitEur, adaptiveMinEdge, sport, executionMetrics: ctxMetrics, resolveExecutionMetrics, onCandidate, resolveMinEp, convictionDisabled } = ctx;
  ...
  const mkP = (match, league, label, odd, reason, prob, boost=0, kickoff=null, bookie=null, signals=null, referee=null, fixtureMeta=null) => {
    ...
    if (ep < minEp) { dropPick('ep_below_min'); return; }
