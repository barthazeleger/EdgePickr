...
// v10.9.2: humanized headers. stats.nba.com checkt op x-nba-stats-* én
// Referer. Geen eigen User-Agent meer (bot-label) — we laten safeFetch de
// geroteerde Chrome UA zetten.
const HEADERS = {
...
async function _get(url) {
  ...
  await rl.acquire();
  return fetchViaBreaker(url, { allowedHosts: ALLOWED, extraHeaders: HEADERS }, breaker);
}
